      ...
      <footer className="container footer items-center mx-auto text-neutral-content">
        <div className="items-center grid-flow-col">
          ...
          >
            ...
            >
              <path
                d="M628 2396 c-305 -54 -517 -233 -594 -501 -14 -50 -18 -117 -21 -390
...
-108 27 -385 35 -500 15z"
              />
              <path
                d="M4967 2392 c-14 -16 -17 -52 -19 -253 l-3 -234 -120 -3 c-161 -4
...
-190 -2 -204 -18z"
              />
              <path
                d="M1987 1882 c-15 -17 -17 -78 -17 -675 0 -644 0 -657 20 -677 19 -19
...
97 -166 0 -187 -2 -201 -18z"
              />
              <path
                d="M3107 1882 c-10 -10 -17 -28 -17 -39 0 -12 115 -293 256 -625 141
...
-18z"
              />
              <path
                d="M6544 1007 c-2 -7 -3 -120 -2 -252 l3 -240 60 0 60 0 5 123 c5 116 7
...
-62 -4 -66 -13z"
              />
              <path
                d="M7478 953 l-3 -68 -38 -3 -38 -3 3 -42 c3 -41 4 -42 41 -45 l37 -3 0
...
64 55 0 55 0 0 44 0 45 -52 3 -53 3 -3 68 -3 67 -54 0 -54 0 -3 -67z"
              />
              <path
                d="M6191 868 c-67 -35 -85 -66 -89 -152 -5 -97 19 -156 75 -184 91 -46
...
-111 -19z"
              />
              <path
                d="M7093 875 c-41 -18 -73 -50 -73 -75 0 -17 7 -20 48 -20 27 0 57 6 68
...
-48 -87 -95 -69 -48 18 -26 65 38 80 51 12 57 11 57 -11z"
              />
              <path
                d="M5914 627 c-3 -8 -4 -36 -2 -63 l3 -49 60 0 60 0 0 60 0 60 -58 3
c-42 2 -59 -1 -63 -11z"
              />
            </g>
          </svg>
        ...
        <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
          ...
          <Link
            href="https://twitter.com/grytChat"
            target="_blank"
            className="link"
          >
